     ...
     %><div class="col-lg-4 col-md-6 mb-4">
              <div class="card h-100">
                ...
                <div class="card-body">
                  ...
                  <h5> 에코포인트:<%= rs.getString(3)%></h5>
                  <p class="card-text"> <%= rs.getString(1)%>님의<%= rs.getString(2)%>의 에코포인트는<%= rs.getString(3)%>입니다</p>
                </div>
                
              </div>
            </div> <%}%><%  }catch(SQLException e){out.println(e);
